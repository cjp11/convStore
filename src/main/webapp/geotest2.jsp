   ...
   if (navigator.geolocation) {
      ...
      navigator.geolocation
            .getCurrentPosition(function(position) {
               ...
               var GsmarkerImage = new kakao.maps.MarkerImage(GsimageSrc,
                     GsimageSize, GsimageOption);
               var CumarkerImage = new kakao.maps.MarkerImage(CuimageSrc,
                     CuimageSize, CuimageOption);
               var EmmarkerImage = new kakao.maps.MarkerImage(EmimageSrc,
                     EmimageSize, EmimageOption);
               ...
               function displayMarker(place) {
                  ...
                  var locMarkerPosition = new kakao.maps.LatLng(lat, lon);
	...
	<form name="map_form" action="start2.do" method="get">
		<hidden input type="text" name="search" id="pn" value="" />
		<input type="text" name="placeName" id="pn2" value="" />
