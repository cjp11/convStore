package com.example.demo.utill.sms;
...
public class SendExample {
	...
	public String SMS(String phone) {
		 ...
		 */
		String api_key = "NCSCGG28Z4PCXYBI";
		String api_secret = "LUBN6SS0RYQFJYDYSOYAAXCVYXRVEDKN";
		...
		set.put("from", "01028551597"); // 발신번호
		set.put("text", "테스트 문자입니다."); // 문자내용
